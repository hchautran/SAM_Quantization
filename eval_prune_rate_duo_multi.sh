...
# CHECKPOINT_EVALUATION="/home/ubuntu/21chi.nh/Quantization/SAM_Quantization/SAM_Quantization/pretrained_checkpoint/prune_rate/duo_sam_hq_epoch_torchnograd_distill_balance10_vit_l_reg-weight_0.5_lr0.01_lr_drop2.pth"
