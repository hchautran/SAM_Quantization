...
def main():
    ...
    # Rotate the weights
    if args.rotate:
        rotation_utils.fuse_layer_norms(sam_model)
        rotation_utils.rotate_model(sam_model, args)
        utils.cleanup_memory(verbos=True)
            
        quant_utils.add_actquant(sam_model) #Add Activation Wrapper to the model
