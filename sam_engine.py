...
def get_default_datasets():
    """Get default dataset configurations — all datasets under ./data/."""
    return [
        {
            "name": "DIS5K-VD",
        ...
        #     "gt_ext": ".png",
        # },
        # Skipped (incompatible mask format):
        #   FSS-1000 — masks are 224×224 RGBA with soft values
        #   DUTS-TE / DUTS-TR — many masks are continuous 0–255 (cascade_psp refinement),
        #     not binary — need thresholding before use as GT.
    ]
